...
#Loop up to number of players to create player objects
    ...
    while num < people:
        ...
        players.append(Player(response[0].lower(), int(response[1])))
        num+=1
...
#Dealer compares their hand to players and decides who wins and side bets
    #Side Bet implementation
        for player in players:
            ...
            print(f"{player.name} got a {bet.result}!  Their old balance was "
                  f"{player.wallet+bet.value}.  Their new balance is "
